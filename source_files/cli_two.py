...
class MyPrompt(Cmd):
    ...
    def help_pickle(self):
        print('pack [filename], enter file to pickle then the name of the pickle file')

    def do_unpickle(self, inp):  # i don't know if this is correct or not
        MyPickle('a', inp).make_pickle()

    def help_unpickle(self):
        print('unpack [picklefilename], enter the name of a text file that has been pickled')
